...
%     imagesc(ef), shading interp ,colormap hot, axis off
% end
% % 
% %reconstructions
% r=[2414 5 30 60 120 250];
% figure(2)
% for a=1:6
%     subplot(2,3,a)
%     rec=u(:,1:r(a))*s(1:r(a),1:r(a))*v(:,1:r(a))';
%     imagesc(reshape(rec(:,1), 192, 168)), shading interp, colormap gray, axis off
% end
%     
%% Plot in 3d first two spaces
% 
% plot3(v(1:64,2),v(1:64,3),v(1:64,3),'ko')
% hold on
% plot3(v(65:129,2),v(65:129,3),v(65:129,3),'ro')
...
save('2_60_truncation.mat', 'NBAc', 'LDAAc', 'SVMAc', 'DTAc', 'KNNc')